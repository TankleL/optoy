...
namespace dx {
    ...
    void DeviceResources::set_swapchainpanel(winrt::Microsoft::UI::Xaml::Controls::SwapChainPanel panel) {
        ...
        HWND hwnd;
        winrt::check_hresult(winrt::raydbg::OneWindow::WindowInstance.as<IWindowNative>()->get_WindowHandle(&hwnd));
        //_dpi = static_cast<float>(::GetDpiForWindow(hwnd)) / 96.f;
    ...
    void DeviceResources::_reset_wsdres() {
        ...
        if (_swapchain != nullptr) {
            ...
            winrt::raydbg::OneWindow::WindowInstance.DispatcherQueue().TryEnqueue([=]() {
